...
net = cv2.dnn.readNet('/media/sf_sharedVBOX/yolov5-opencv-cpp-python-main/config_files/yolov5s.onnx')
...
image = cv2.imread('/media/sf_sharedVBOX/yolov5-opencv-cpp-python-main/misc/corrida-crianças-1280x720.jpg')
